                ...
                <CContainer>
                    <CRow className="justify-content-center">
                        <CCol md={8} lg={9} xl={10}>
                            <h1 className="display-4 text-primary mt-5 fw-medium">
                                Privacy Policy
                            </h1>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="ms-3">
                                    ...
                                    us, such as your name, email address and shipment information.
                                    <div className="mb-3" />
                                    <h5>Usage Data:</h5>
                                    We may collect information about how you use our services,
                                    including IP address, user agent, geolocation, console errors,
                                    and URL visits.
                                    <div className="mb-3" />
